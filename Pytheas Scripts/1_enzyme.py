...
(up to 4), 3' and 5' chemistry [P, OH cP, Ap] for the nucleolytic fragments and the whole RNA molecule are optional.
...
--cleaved_fragments_5end_chem (OPTIONAL, DEFAULT='OH') -> 5' chemistry of the RNA nucleolytic fragments
                            Possible choices=['OH', 'P', 'App' ]. NOTE: parameters input without "=" nor comma.
...
--RNA_5end_chem (OPTIONAL, DEFAULT='P') -> 5' chemistry of the input RNA molecule(s) ['OH', 'P', 'App'].
...
parser.add_argument('--enzyme', choices=['A', 'T1', 'U2', 'none', 'nonspecific', 'hRNase4', 'Cus',
...
parser.add_argument("--cleaved_fragments_5end_chem", nargs='*', default=['OH'], choices=['OH', 'P', 'App'],
                    help="Set the 5' chemistry of the RNA fragments cleaved from the chosen endonuclease to be 'OH' 'P' or 'App'. Input of values spaced without '=' nor commas (default = OH)")
parser.add_argument("--cleaved_fragments_3end_chem", nargs='*', default=['OH'], choices=['OH', 'P', 'cP'],
...
parser.add_argument("--RNA_5end_chem", nargs='*', default=['OH'], choices=['OH', 'P','App'],
                    help="Set the 5' chemistry of the input RNA molecule(s) [options are 'OH' 'P' 'App']. "
...
def enzyme_cut():
    ...
    """
    return {'A': ['C*', 'U*'], 'T1': ['G*'], 'hRNase4': ['U*A', 'U*G'], 'U2': ['A*', 'G*'], 'Cus': ['C*A', 'C*G', 'C*U'],
